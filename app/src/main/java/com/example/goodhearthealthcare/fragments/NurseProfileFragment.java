...
public class NurseProfileFragment extends Fragment {
    ...
    TextView bookAppointmentText, nurseName, nurseSpecialist, nurseEmail, selectDateText, selectTimeText;
    ...
    String nurseIDStr, patientID;
    DatabaseReference nursesRef, patientRef;
    FirebaseAuth mAuth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        nurseIDStr = this.getArguments().getString("staffPhone");
        patientRef = FirebaseDatabase.getInstance().getReference().child("Patients");
        nursesRef = FirebaseDatabase.getInstance().getReference();

        appointmentLayout = view.findViewById(R.id.appointmentLayout);
        nurseName = view.findViewById(R.id.nurseName);
        nurseEmail = view.findViewById(R.id.nurseEmail);
        ...
        appointmentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference doctorsAppRef = nursesRef.child("AppointmentRequest");
                ...
                if (patientName.isEmpty() || patientPhone.isEmpty() || patientAddress.isEmpty() || appDate.isEmpty() || appTime.isEmpty()) {
                    ...
                    appointmentReqMap.put("NurseID", nurseIDStr);
                    appointmentReqMap.put("DoctorName", nurseName.getText().toString());
        ...
        nursesRef.child("Staffs").child("Nurse").child(nurseIDStr).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    nurseName.setText(dr_name);
                    nurseEmail.setText(dr_email);
                    loadingBar.dismiss();
                }
            }
